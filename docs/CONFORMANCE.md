...
`generateCoverage` whenever fixtures change. At the time of writing that is 451 of 3841 nodes
(11.7%), with `Type.Type` alone accounting for 268 — but read the artifact, not this sentence.
